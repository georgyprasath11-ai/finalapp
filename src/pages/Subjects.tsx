...
import { Palette, Plus, Pencil, Trash2, Check, X } from 'lucide-react';
      ...
      <main className="flex-1 p-4 md:p-8 pb-24 md:pb-8 overflow-auto">
        <div className="max-w-3xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">Manage subjects and customize colors</p>
          </div>
          ...
          <div className="space-y-2">
            {subjects.map((subject) => (
              <div key={subject.id} className="flex items-center gap-3 p-4 rounded-xl border bg-card hover:shadow-medium transition-all group">
