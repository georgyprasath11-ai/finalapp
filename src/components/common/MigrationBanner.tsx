  ...
  return (
    <div className="rounded-2xl border border-sky-400/35 bg-sky-500/10 px-4 py-3 text-sm text-sky-100">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <p>
          Looks like you have existing study data but no Habits or Weekly Review data yet. If you exported from a
          previous deployment, you can import it in Settings.
        </p>
